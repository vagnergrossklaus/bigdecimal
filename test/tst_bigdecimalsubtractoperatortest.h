...
class BigDecimalSubtractOperatorTest : public ::testing::TestWithParam<std::tuple<BigDecimal, BigDecimal, BigDecimal> > {};

INSTANTIATE_TEST_SUITE_P(
    testBigDecimalSubtractOperator,
    BigDecimalSubtractOperatorTest,
    ::testing::Values(
        ...
        std::make_tuple( BigDecimal( 5.00, 0 ), BigDecimal( 2.00, 0 ), BigDecimal( 3.00, 0 ) ),
        std::make_tuple( BigDecimal( 5.00, 1 ), BigDecimal( 2.00, 1 ), BigDecimal( 3.00, 1 ) ),
        std::make_tuple( BigDecimal( 5.00, 2 ), BigDecimal( 2.00, 2 ), BigDecimal( 3.00, 2 ) ),
        std::make_tuple( BigDecimal( 5.00, 3 ), BigDecimal( 2.00, 3 ), BigDecimal( 3.00, 3 ) ),
        std::make_tuple( BigDecimal( 5.00, 0 ), BigDecimal( 6.00, 0 ), BigDecimal( -1.00, 0 ) ),
        std::make_tuple( BigDecimal( 5.00, 1 ), BigDecimal( 6.00, 1 ), BigDecimal( -1.00, 1 ) ),
        std::make_tuple( BigDecimal( 5.00, 2 ), BigDecimal( 6.00, 2 ), BigDecimal( -1.00, 2 ) ),
        std::make_tuple( BigDecimal( 21.00, 2 ), BigDecimal( 18.00, 2 ), BigDecimal( 3.00, 2 ) )
...
TEST_P( BigDecimalSubtractOperatorTest, testBigDecimalSubtractOperator ) {

    std::tuple<BigDecimal, BigDecimal, BigDecimal> params = GetParam();

    BigDecimal decimalSubtract = std::get<0>( params ) - std::get<1>( params );

    EXPECT_EQ( decimalSubtract.intPart(), std::get<2>( params ).intPart() );
    EXPECT_EQ( decimalSubtract.fractPart(), std::get<2>( params ).fractPart() );
    EXPECT_EQ( decimalSubtract.precision(), std::get<2>( params ).precision() );
